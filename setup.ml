...
(* OASIS_START *)
(* DO NOT EDIT (digest: f9a266e4987995d94a7d79c9fc74a6d3) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_pci_db", []))];
     ...
     package =
       {
          ...
          authors = ["Si Beaumont"];
          homepage = Some "https://github.com/simonjbeaumont/ocaml-pci-db";
          synopsis =
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pci_db"; "Pci_db_types"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Pci_ids_lexer"; "Pci_ids_parser"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "pci-db";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_pci_db.ml"});
               Test
                 ({
                     cs_name = "test_pci_db";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "test_pci_db"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\2298D\226P\156x5\025\146JCt\254\225\214";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
